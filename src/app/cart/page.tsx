...
//                   <p className="font-medium">{item.name}</p>
//                   {item.foil !== "nonfoil" && (
//                     <div className="inline-block px-2 py-1 text-xs font-semibold text-white bg-gradient-to-r from-yellow-400 to-red-500 rounded">
//                       {item.foil}
//                     </div>
//                   )}
...
//                 <p className="font-medium">Set {item.set_name}</p>
...
//                     onClick={() => {
//                       if (item.quantity <= 1) {
//                         removeFromCart(item.id); // 💥 удаляем
//                       } else {
