...
// components/cart/CartItemsList/CartItemsList.tsx
"use client";
  ...
  return (
    <div className="flex-1 flex flex-col divide-y">
      {items.map((item) => {
        ...
        // "fullset_arb" → "arb"
        const setCode = isFullset
          ? item.id.replace(/^fullset_/, "")
          : null;
        ...
        return (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              {/* META — різне для карти і фулсету */}
              {isFullset ? (
                // Фулсет: тільки код сету
                <p className="text-sm text-muted-foreground uppercase tracking-wide">
                  {setCode} • {item.language}
                </p>
              ) : (
                // Карта: повна мета
                <>
